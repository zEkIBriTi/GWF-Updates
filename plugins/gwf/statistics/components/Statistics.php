...
namespace Gwf\Statistics\Components;
...
use Gwf\Statistics\Models\Statistic;
...
{   
    ...
    */
    ...
    public function  onRun(){
        ...
        $this->statistics = $this->page['statistics'] = $this->loadStatistics();
    }
    ...
    protected function loadStatistics(){
        ...
        return Statistic::orderby('id','DESC')->paginate($recordsPerPage, $pageNumber);
    } 
