...
class Singleproject extends ComponentBase
{
    ...
    public function componentDetails()
    {
        return [
            'name'        => 'Project Detail',
            'description' => 'Show single Project detail'
        ];
    }
    ...
    {
        $this->prepareVars();
        $this->project = $this->page['project'] = $this->loadSingleproject();
    }
    ...
    protected function loadSingleproject()
    {
        if (!strlen($this->identifierValue)) {
            return;
        }
        return Projectandinvestment::where($this->modelKeyColumn, '=', $this->identifierValue)->first();
    }
}