...
namespace Gwf\Projectandinvestment\Components;
...
class Projectandinvestmentlist extends ComponentBase
{   
    /**
    ...
    */
    ...
    public $projectandinvestments;

    public function componentDetails()
    {
        return [
            'name'        => 'Project & Investment List',
            'description' => 'List of Project and investment'
        ];
    }
    ...
    public function  onRun(){
        ...
        $this->projectandinvestments = $this->page['projectandinvestments'] = $this->loadProjectandinvestments();
    }

    protected function loadProjectandinvestments(){
        ...
        return Projectandinvestment::where('activation_status',1)->orderby('id','DESC')->paginate($recordsPerPage, $pageNumber);
    }  
