...
namespace Gwf\Advertisements\Components;
...
class AdvertisementsList extends ComponentBase
{   
    /**
    ...
    */
    ...
    public function componentDetails()
    {
        return [
            ...
            'description' => 'Displays the list of Advertisements'
        ];
    }
    ...
    public function  onRun(){
        ...
        $this->advertisement = $this->page['advertisement'] = $this->loadAdvertisement();
    }
    ...
    protected function loadAdvertisement(){
        ...
        return Advertisement::where('activation_status',1)->orderby('id','DESC')->paginate($recordsPerPage, $pageNumber);
    }  
