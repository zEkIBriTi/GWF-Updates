...
class AllNews extends ComponentBase
{   
    /**
    ...
    */
    ...
    protected function loadNews(){
        ...
        return News::where('activation_status',1)->orderby('id','DESC')->paginate($recordsPerPage, $pageNumber);
    }  
