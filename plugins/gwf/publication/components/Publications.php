...
namespace Gwf\Publication\Components;
...
{   
    ...
    */
    ...
    {
        return [
            'name'        => 'Home Publications List',
            'description' => 'List of Publications for Homepage'
        ];
    }
    ...
    protected function loadPublications(){
        ...
        return Publication::where('activation_status',1)->orderby('id','DESC')->paginate($recordsPerPage, $pageNumber);
    }  
