...
namespace Gwf\Economicactivities\Components;
...
class EconomicActivities extends ComponentBase
{   
    /**
    ...
    */
    ...
    public function  onRun(){
        ...
        $this->economicactivities = $this->page['economicactivities'] = $this->loadEconomicActivities();
    }

    protected function loadEconomicActivities(){
        ...
        return EconomicActivity::where('activation_status',1)->orderby('id','DESC')->paginate($recordsPerPage, $pageNumber);
    }  
