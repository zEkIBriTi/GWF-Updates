...
namespace Gwf\Howdoi\Components;
...
class Howdoilinks extends ComponentBase
{   
    /**
    ...
    */
    ...
    public function  onRun(){
        ...
        $this->howdoilinks = $this->page['howdoilinks'] = $this->loadhowdoilink();
    }

    protected function loadHowdoilink(){
        ...
        return HowDoI::where('activation_status',1)->orderby('id','DESC')->paginate($recordsPerPage, $pageNumber);
    } 
