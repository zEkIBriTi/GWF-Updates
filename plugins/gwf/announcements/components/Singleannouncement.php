<?php namespace Gwf\Announcements\Components;
...
class Singleannouncement extends ComponentBase
{
    /**
    ...
    public function componentDetails()
    {
        return [
            ...
            'description' => 'Show single announcement detail'
        ];
    }
    ...
    {
        $this->prepareVars();
        $this->announcement = $this->page['announcement'] = $this->loadSingleannouncement();
    }
    ...
    protected function loadSingleannouncement()
    {
        if (!strlen($this->identifierValue)) {
            return;
        }
        return Announcements::where($this->modelKeyColumn, '=', $this->identifierValue)->first();
    }
}