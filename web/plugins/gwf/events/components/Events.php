...
namespace Gwf\Events\Components;
...
{   
    ...
    */
    ...
    public function  onRun(){
        ...
        $this->events = $this->page['events'] = $this->loadAnnouncements();
    }
    ...
    protected function loadAnnouncements(){
        ...
        return Event::where('activation_status',1)->orderby('id','DESC')->paginate($recordsPerPage, $pageNumber);
    }  
