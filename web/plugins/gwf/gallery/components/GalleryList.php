...
class GalleryList extends ComponentBase
{
    ...
    {
        $this->prepareVars();
        $this->galleries = $this->listGallery();
    }
    ...
    protected function listGallery()
    {
        ...
        if (!strlen($recordsPerPage)) {
            ...
            return Gallery::where('activation_status', 1)->get();
        }
        ...
        $galleries = Gallery::where('activation_status',1)->orderby('id','DESC')->paginate($recordsPerPage, $pageNumber);
        return $galleries; 
    }
