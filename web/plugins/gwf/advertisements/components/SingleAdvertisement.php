<?php namespace Gwf\Advertisements\Components;
...
class SingleAdvertisement extends ComponentBase
{
    /**
    ...
    public function componentDetails()
    {
        return [
            ...
            'description' => 'Shows single advertisement in detail'
        ];
    }
    ...
    protected function loadAdvertisement()
    {
        ...
        return Advertisement::where($this->modelKeyColumn, '=', $this->identifierValue)->first();
    }
}